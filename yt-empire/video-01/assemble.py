...
SEG = {
 ...
 4: [CA("K9.png",1.1), B("neutral",0.9), KB("Z4.png",1.0,"out"), C("V3C.mp4",0.0,1.1), CA("K10.png",1.0), B("point",0.9),
     C("V3C.mp4",3.0,1.1), C("V3C.mp4",5.2,1.1,"z"), KB("Z4.png",0.9), KB("N5.png",1.0,"out"), C("V4.mp4",0.0,1.1),
 ...
 5: [B("shock",0.9), C("V5.mp4",0.0,1.1), C("V5.mp4",2.6,1.0), CA("K12a.png",0.8), CA("K5.png",1.0), B("think",0.9),
     ...
     C("V5.mp4",3.8,1.1), CA("K12c.png",0.8), C("V3C.mp4",3.2,1.0), KB("Z8.png",1.1), C("V5.mp4",5.6,1.1)],
